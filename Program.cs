                ...
                else if (event_decider == 3)
                {
                    ...
                    if (rand_roll.Next(0, 100) <= 50)
                    {
                        ...
                        if (manchester_main[penalty_decider] > 0)
                        {
                            ...
                            manchester_reds++;
                            Console.WriteLine(
                                $"Manchester player {penalty_decider} has been sent off (Straight Red) at minute {i}.");
                        }
                    }
                    else
                    {
                        ...
                        if (arsenal_main[penalty_decider] > 0)
                        {
                            ...
                            arsenal_reds++;
                            Console.WriteLine(
                                $"Arsenal player {penalty_decider} has been sent off (Straight Red) at minute {i}.");
                        }
                    }
                }
                    ...
                    if (rand_roll.Next(0, 100) <= 50)
                    {
                        if (manchester_subs < 5)
                        {
                            ...
                            if (biggest_reserve > smallest_main)
                            {
                                ...
                                manchester_subs++;
                                Console.WriteLine(
                                    $"Manchester: Player {strongestReserveIndex} replaces Player {weakestIndex} at minute {i}.");
                            }
                        }
                    }
                    else
                    {
                        if (arsenal_subs < 5)
                        {
                            ...
                            if (biggest_reserve > smallest_main)
                            {
                                ...
                                arsenal_subs++;
                                Console.WriteLine(
                                    $"Arsenal: Player {strongestReserveIndex} replaces Player {weakestIndex} at minute {i}.");
                            }
                        }
                    }
                }
                else if (event_decider == 5)
                {
                    if (rand_roll.Next(0, 101) <= 50)
                    {
                        ...
                        if (manchester_main[penalty_decider] - 20 <= 0)
                        {
                            ...
                            Console.WriteLine(
                                $"Manchester player {penalty_decider} has contracted an injury at minute {i}.");
                        }
                        else
                        {
                ...
                else if (event_decider == 6)
                {
                    ...
                    if (arsenal_main[penalty_decider] > 0)
                    {
                        if (arsenal_main[penalty_decider] - 20 <= 0)
                        {
                            ...
                            Console.WriteLine(
                                $"Arsenal player {penalty_decider} has contracted an injury at minute {i}.");
                        }
                        else
                        {
